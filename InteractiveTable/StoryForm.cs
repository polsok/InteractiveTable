...
namespace InteractiveTable
{
    public partial class StoryForm : Form
    {
        ...
        private static List<AccidentObj> AccidentHistoryList;
        public StoryForm()
        {
            InitializeComponent();
            try
            {
                AccidentHistoryList = new List<AccidentObj>();
        ...
        private void CreateHeadersAndFillListView()
        {
            try
            {
                ...
                for (int i = 0; i < AccidentHistoryList.Count; i++)
                {
                    ...
                    lvsi.Text = AccidentHistoryList[i].Adress;
                    ...
                    lvsi = new ListViewItem.ListViewSubItem();
                    lvsi.Text = AccidentHistoryList[i].TimeAccident;
                    lvi.SubItems.Add(lvsi);
